...
class SingleConnectionThread extends Thread{
	 ...
	 * @param clientSocket
	 */
	public SingleConnectionThread (Socket clientSocket) {
...
public class NoleggiaSciServer {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    try {
	    	...
	    	while (true) {
	    		...
	    		try {
	    			new SingleConnectionThread (clientSocket).start();
	    		}
	    		catch (Exception e) {
