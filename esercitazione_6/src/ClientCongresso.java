...
class ClientCongresso {
	...
	public static void main(String[] args) {
		...
		try {
			...
			RegistryRemotoTagClient registryRemotoTag = (RegistryRemotoTagClient) Naming.lookup(completeRemoteRegistryName);
			ServerCongresso serverRMI = (ServerCongresso) registryRemotoTag.cercaTag("congresso")[0];
